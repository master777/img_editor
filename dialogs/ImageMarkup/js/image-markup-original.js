...
(function ($) {
    ...
    $.fn.imageMarkup = function (options) {
        ...
        this.setPenColor = function (color) {
            ...
            $('.image-markup-canvas').css('cursor', "url(img-original/" + color + "-pen.png) 14 50, auto");
        }

        this.setCursorHandOpen = function () {
            $('.image-markup-canvas').css('cursor', "url(img-original/hand-open.png) 25 25, auto");
        }

        this.setCursorHandClose = function () {
            $('.image-markup-canvas').css('cursor', "url(img-original/hand-close.png) 25 25, auto");
        }
